    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$2, 110, 8, 3012);
    		},
    	...
    	dispatch_dev("SvelteRegisterBlock", { block, id: create_else_block.name, type: "else", source: "(110:6) {:else}", ctx });
    	return block;
    }

    // (108:6) {#if parseIndex(question.index) < 10 || parseIndex(question.index) % 10 == 0}
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$2, 108, 8, 2932);
    		},
    	...
    	dispatch_dev("SvelteRegisterBlock", { block, id: create_if_block.name, type: "if", source: "(108:6) {#if parseIndex(question.index) < 10 || parseIndex(question.index) % 10 == 0}", ctx });
    	return block;
    }

    // (101:2) {#each multiplicationTableQuiz.getQuestions() as question (question.index)}
    function create_each_block(key_1, ctx) {
    	...
    	const block = {
    		...
    		c: function create() {
    			...
    			add_location(div, file$2, 101, 4, 2494);
    			this.first = div;
    		},
    	...
    	dispatch_dev("SvelteRegisterBlock", { block, id: create_each_block.name, type: "each", source: "(101:2) {#each multiplicationTableQuiz.getQuestions() as question (question.index)}", ctx });
    	return block;
    }
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$2, 99, 0, 2384);
    		},
    ...
    function instance$1($$self, $$props, $$invalidate) {
      ...
      const navigationHandler = new NavigationHandler({
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ('highlightedFieldsRow' in $$props) highlightedFieldsRow = $$props.highlightedFieldsRow;
    	};

    	let allAnsweredFieldsIndexes, highlightedFieldsRow;
    	...
    	$$self.$$.update = ($$dirty = { fieldsAnsweredCorrectly: 1, fieldsAnsweredInorrectly: 1, focusedFieldIndex: 1 }) => {
    		...
    		if ($$dirty.focusedFieldIndex) { highlightedFieldsRow = Math.floor(focusedFieldIndex / 10); }
    	};
