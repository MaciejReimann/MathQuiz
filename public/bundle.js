    ...
    ***************************************************************************** */
    ...
    var QuizQuestion = /** @class */ (function () {
        function QuizQuestion(parentQuizName, question, correctAnswers, listeners) {
            ...
            this.getCorrectAnswersCount = function () { return _this.correctAnswerCount; };
            this.parentQuizName = parentQuizName;
            this.question = question;
            this.correctAnswers = correctAnswers;
    ...
    var PATH_TO_QUIZZES = "v1/quizzes";
    var fetchData = function () {
        axios$1
            .get("" + QUIZ_API_URL.dev + PATH_TO_QUIZZES)
            .then(function (data) { return console.log(data); });
    };
    var formatQuizData = function (allQuizzes) {
        return allQuizzes.flat().map(function (q) { return ({
    ...
    var submitQuizzes = function (allQuizzes) {
        //   console.log("allQuizzes", JSON.stringify(allQuizzes))
        var postData = { name: allQuizzes[0].name, questions: "sokdnf" };
        var formattedData = formatQuizData(allQuizzes);
    ...
    function create_fragment$a(ctx) {
    	var div, header1, t0, main, t1, button, t3, footer, current, dispose;
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(header1, file$a, 55, 2, 1045);
    			add_location(button, file$a, 62, 4, 1144);
    			attr_dev(main, "class", "main svelte-3wugrf");
    			add_location(main, file$a, 59, 2, 1099);
    			attr_dev(footer, "class", "footer svelte-3wugrf");
    			add_location(footer, file$a, 69, 2, 1278);
    			attr_dev(div, "class", "app svelte-3wugrf");
    			add_location(div, file$a, 53, 0, 1024);
    ...
    function instance$a($$self) {
      ...
      setContext("scoreStore", scoreStore);
    	...
    	const click_handler = () => submitQuizzes(quizStore.getAnsweredQuestionsForAllQuizzes());
