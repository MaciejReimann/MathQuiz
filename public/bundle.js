...
var app = (function () {
    ...
    function create_fragment$1(ctx) {
    	...
    	var numericdisplay1 = new NumericDisplay({
    		props: { text: "score", numbers: score },
    		$$inline: true
    	});
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$1, 26, 2, 482);
    			attr_dev(header, "class", "header svelte-19t0g86");
    			add_location(header, file$1, 22, 0, 404);
    		},
    ...
    ***************************************************************************** */
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(input, file$2, 43, 0, 727);
    ...
    class NumericInput extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$1, create_fragment$2, safe_not_equal, ["onSubmit", "onNavigate", "isFocused"]);
    ...
    function create_else_block(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", { block, id: create_else_block.name, type: "else", source: "(114:6) {:else}", ctx });
    	return block;
    }

    // (112:6) {#if parseIndex(question.index) < 10 || parseIndex(question.index) % 10 == 0}
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div = element("div");
    			t = text(t_value);
    			add_location(div, file$3, 112, 8, 3008);
    		},
    	...
    	dispatch_dev("SvelteRegisterBlock", { block, id: create_if_block.name, type: "if", source: "(112:6) {#if parseIndex(question.index) < 10 || parseIndex(question.index) % 10 == 0}", ctx });
    	return block;
    }

    // (102:2) {#each multiplicationTableQuiz.getQuestions() as question (question.index)}
    function create_each_block(key_1, ctx) {
    	...
    	const block = {
    		...
    		c: function create() {
    			...
    			add_location(div, file$3, 102, 4, 2368);
    			this.first = div;
    		},
    	...
    	dispatch_dev("SvelteRegisterBlock", { block, id: create_each_block.name, type: "each", source: "(102:2) {#each multiplicationTableQuiz.getQuestions() as question (question.index)}", ctx });
    	return block;
    }
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$3, 100, 0, 2258);
    		},
