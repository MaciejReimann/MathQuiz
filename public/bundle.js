...
var app = (function () {
    ...
    ***************************************************************************** */
    ...
    class NumericInputv2 extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$2, create_fragment$2, safe_not_equal, ["submittedValue", "onSubmit", "onNavigate", "onFocus", "maxLength"]);
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$3, 42, 8, 826);
    		},
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$3, 35, 8, 588);
    		},
    ...
    function create_each_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$3, 33, 4, 531);
    		},
    	...
    	dispatch_dev("SvelteRegisterBlock", { block, id: create_each_block.name, type: "each", source: "(33:2) {#each equation.getInArray() as element}", ctx });
    	return block;
    }
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$3, 31, 0, 462);
    		},
    ...
    class SingleEquation extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$3, create_fragment$3, safe_not_equal, ["equation"]);
    ...
    function create_each_block$1(key_1, ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", { block, id: create_each_block$1.name, type: "each", source: "(40:2) {#each quiz.getAnsweredQuestions() as answeredEquation (answeredEquation.ID)}", ctx });
    	return block;
    }
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$4, 38, 0, 1129);
    		},
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file$5, 47, 2, 971);
    			attr_dev(main, "class", "main svelte-1hc2uby");
    			add_location(main, file$5, 51, 2, 1019);
    			attr_dev(div1, "class", "app svelte-1hc2uby");
    			add_location(div1, file$5, 46, 0, 951);
    		},
