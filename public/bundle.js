...
var app = (function () {
    ...
    ***************************************************************************** */
    ...
    var Quiz = /** @class */ (function () {
        function Quiz(answeredQuestions, quizID, handlers) {
            var _this = this;
            this.answeredQuestions = null;
            this.quizID = null;
            this.getQuestions = function () { return _this.answeredQuestions; };
            this.submitAnswer = function (submittedAnswer, i) {
                _this.answeredQuestions = _this.answeredQuestions.map(function (quizQuestion) {
            ...
            this.answeredQuestions = answeredQuestions.map(function (qa, i) { return (__assign(__assign({ index: quizID + "." + i }, qa), { submittedAnswers: [] })); });
            this.quizID = quizID;
    ...
    function create_else_block(ctx) {
    	...
    	var quizquestion = new QuizQuestion({
    		props: { submitAnswerHandler: func },
    		$$inline: true
    	});
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$2, 76, 8, 1806);
    		},
    ...
    function create_if_block(ctx) {
    	var div, t_value = ctx.question.answers[0] + "", t;
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$2, 74, 8, 1733);
    		},
    ...
    function create_each_block(key_1, ctx) {
    	...
    	const block = {
    		...
    		c: function create() {
    			...
    			add_location(div, file$2, 69, 4, 1486);
    			this.first = div;
    		},
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$2, 67, 0, 1401);
    		},
