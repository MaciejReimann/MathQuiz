    ...
    ***************************************************************************** */
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$2, 108, 8, 2747);
    		},
    	...
    	dispatch_dev("SvelteRegisterBlock", { block, id: create_else_block.name, type: "else", source: "(108:6) {:else}", ctx });
    	return block;
    }

    // (106:6) {#if parseIndex(question.index) < 10 || parseIndex(question.index) % 10 == 0}
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$2, 106, 8, 2667);
    		},
    	...
    	dispatch_dev("SvelteRegisterBlock", { block, id: create_if_block.name, type: "if", source: "(106:6) {#if parseIndex(question.index) < 10 || parseIndex(question.index) % 10 == 0}", ctx });
    	return block;
    }

    // (98:2) {#each multiplicationTableQuiz.getQuestions() as question (question.index)}
    function create_each_block(key_1, ctx) {
    	...
    	const block = {
    		...
    		c: function create() {
    			...
    			toggle_class(div, "highlightedColumn", checkIfColumnFieldShouldBeHighlighted(ctx.question.index, ctx.focusedFieldIndex));
    			toggle_class(div, "highlightedRow", checkIfRowFieldShouldBeHighlighted(ctx.question.index, ctx.focusedFieldIndex));
    			add_location(div, file$2, 98, 4, 2198);
    			this.first = div;
    		},
    	...
    	dispatch_dev("SvelteRegisterBlock", { block, id: create_each_block.name, type: "each", source: "(98:2) {#each multiplicationTableQuiz.getQuestions() as question (question.index)}", ctx });
    	return block;
    }
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$2, 96, 0, 2088);
    		},
    ...
    function instance$1($$self, $$props, $$invalidate) {
      ...
      const navigationHandler = new NavigationHandler({
    	...
    	$$self.$inject_state = $$props => {
    		if ('currentFieldIndex' in $$props) currentFieldIndex = $$props.currentFieldIndex;
