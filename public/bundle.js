...
var app = (function () {
    ...
    ***************************************************************************** */
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(input, file$1, 43, 0, 727);
    ...
    function create_else_block(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", { block, id: create_else_block.name, type: "else", source: "(117:6) {:else}", ctx });
    	return block;
    }

    // (115:6) {#if parseIndex(question.index) < 10 || parseIndex(question.index) % 10 == 0}
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div = element("div");
    			t = text(t_value);
    			attr_dev(div, "class", "svelte-12whjp7");
    			add_location(div, file$2, 115, 8, 3008);
    		},
    	...
    	dispatch_dev("SvelteRegisterBlock", { block, id: create_if_block.name, type: "if", source: "(115:6) {#if parseIndex(question.index) < 10 || parseIndex(question.index) % 10 == 0}", ctx });
    	return block;
    }

    // (105:2) {#each multiplicationTableQuiz.getQuestions() as question (question.index)}
    function create_each_block(key_1, ctx) {
    	...
    	const block = {
    		...
    		c: function create() {
    			...
    			if_block.c();
    			t = space();
    			attr_dev(div, "class", "" + 'cell' + " svelte-12whjp7");
    			...
    			add_location(div, file$2, 105, 4, 2368);
    			this.first = div;
    		},
    	...
    	dispatch_dev("SvelteRegisterBlock", { block, id: create_each_block.name, type: "each", source: "(105:2) {#each multiplicationTableQuiz.getQuestions() as question (question.index)}", ctx });
    	return block;
    }
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "class", "table-wrapper svelte-12whjp7");
    			add_location(div, file$2, 103, 0, 2258);
    		},
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$3, 9, 0, 165);
    		},
