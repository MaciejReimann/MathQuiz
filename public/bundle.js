    ...
    */
    ...
    function create_fragment$6(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(input, file$6, 83, 0, 1679);
    ...
    function instance$6($$self, $$props, $$invalidate) {
      ...
      const handleInput = (inputData, src) => {
        if (src === "voice") {
          ...
          if (includeAnyNumbers) {
            $$invalidate('displayedInputValue', displayedInputValue = inputData.match(/\d+/g).map(Number)[0]);
          }
        } else if (isNaN(parseInt(inputData))) {
          $$invalidate('displayedInputValue', displayedInputValue = displayedInputValue.slice(
            0,
      ...
      const handleKeydown = e => {
    	...
    	const input_handler = (e) => handleInput(e.data);
    	...
    	$$self.$capture_state = () => {
    		return { onSubmit, onNavigate, onFocus, maxLength, inputNode, displayedInputValue, isFocused };
    	};
    ...
    function create_else_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$7, 49, 8, 1022);
    		},
    	...
    	dispatch_dev("SvelteRegisterBlock", { block, id: create_else_block$1.name, type: "else", source: "(49:6) {:else}", ctx });
    	return block;
    }
    ...
    function create_fragment$a(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(header1, file$a, 53, 2, 1029);
    			attr_dev(main, "class", "main svelte-3wugrf");
    			add_location(main, file$a, 57, 2, 1083);
    			attr_dev(footer, "class", "footer svelte-3wugrf");
    			add_location(footer, file$a, 63, 2, 1138);
    			attr_dev(div, "class", "app svelte-3wugrf");
    			add_location(div, file$a, 51, 0, 1008);
    		},
