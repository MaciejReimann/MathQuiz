...
var app = (function () {
    ...
    function create_default_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file$1, 62, 6, 1224);
    			attr_dev(div1, "class", "number svelte-1y2uj2o");
    			add_location(div1, file$1, 63, 6, 1267);
    			attr_dev(div2, "class", "strike svelte-1y2uj2o");
    			add_location(div2, file$1, 61, 4, 1197);
    		},
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$1, 58, 2, 1109);
    			attr_dev(div, "class", "wrapper svelte-1y2uj2o");
    			add_location(div, file$1, 54, 0, 1033);
    		},
    ...
    ***************************************************************************** */
    ...
    /* src/AppletWindow/AppletWindow.svelte generated by Svelte v3.12.1 */

    const file$7 = "src/AppletWindow/AppletWindow.svelte";
    ...
    class AppletWindow extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$7, create_fragment$7, safe_not_equal, []);
    		dispatch_dev("SvelteRegisterComponent", { component: this, tagName: "AppletWindow", options, id: create_fragment$7.name });
    	}
    }
    ...
    function create_fragment$8(ctx) {
    	...
    	var appletwindow = new AppletWindow({ $$inline: true });
    	...
    	const block = {
    		...
    		m: function mount(target, anchor) {
    			...
    			append_dev(div, t0);
    			append_dev(div, main);
    			mount_component(appletwindow, main, null);
    			append_dev(div, t1);
    		...
    		i: function intro(local) {
    			...
    			transition_in(appletwindow.$$.fragment, local);
    		...
    		o: function outro(local) {
    			...
    			transition_out(appletwindow.$$.fragment, local);
    		...
    		d: function destroy(detaching) {
    			...
    			destroy_component(appletwindow);
