...
InputField.prototype.create = function(position) {
...
const EquationParagraph = function(x,y,index) {
  ...
  this.index = index;
  this.elementX = new InputField(this.x).create("x")
  this.elementY = new InputField(this.y).create("y")
  this.elementZ = new InputField(this.z).create("z")
  this.elementMultiplication = new InputField("*").create()
  this.elementEqual = new InputField("=").create()
  this.elementBlank = new InputField("").create()
  // this.blankPosition ;
  this.userAnswer = "";
};
...
const test = function() {
	return new ArrayOfEquations().getOrdered()
};
...
const controller = function() {
	...
	const array = [
		...
		(function() {
			// const array = [new EquationParagraph(1,5,0)]
			let testArray = new ArrayOfEquations();
			testArray.setBlankPositionForAll("z");
			// array[0].setBlankPosition("z")
			return testArray.getOrdered();
		}),
...
view.update = function(v) {
	...
	inputFocus();
	controller().setCurrentArrayIndex( 0 );
